      ...
      <div className="rounded-md border border-[#e4e4e7] shadow px-6 py-4 my-3">
        <table className="border-collapse w-full text-left text-sm">
          <caption className="py-2">
            <p className="text-2xl font-bold text-left text-primary">Events</p>
          </caption>
          ...
          <tbody>
            {examData.map((exam, index) => (
              ...
              >
                ...
                <td>
                  <span className="py-2 font-semibold px-2 block">
                    <button className="text-primary py-2 px-4 rounded border border-primary select-none">
                      Download
                    </button>
                  </span>
                </td>
